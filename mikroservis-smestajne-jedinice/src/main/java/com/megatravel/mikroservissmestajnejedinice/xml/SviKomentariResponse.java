 ...
 *       &lt;sequence>
 *         &lt;element name="komentari" type="{http://www.megatravel.com/mikroservissmestajnejedinice/xml}KomentarDTO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "sviKomentariResponse")
public class SviKomentariResponse {

    protected List<KomentarDTO> komentari;
    ...
    public List<KomentarDTO> getKomentari() {
        if (komentari == null) {
            komentari = new ArrayList<KomentarDTO>();
        }
